...
Make sure CORS is properly configured in the Laravel backend if the frontend is running on a different port than **5173** (change ```cors.php``` on the config folder inside backend).
